    ...
    <div class="bg-card-surface rounded-xl shadow-ambient p-8 border border-border-base">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <a class="bg-secondary-container hover:bg-blue-700 text-white p-6 rounded-xl transition-colors flex flex-col items-center justify-center gap-3 text-center group" href="<?= e(url('candidate.jobs.index')) ?>">
                ...
                <span class="text-xl font-medium">Recruitment Pipeline & Triage</span>
            </a>
            <a class="bg-card-surface hover:bg-surface-container-low border border-outline-variant text-primary p-6 rounded-xl transition-colors flex flex-col items-center justify-center gap-3 text-center group" href="<?= e(url('candidate.applications.index')) ?>">
                ...
                <span class="text-xl font-medium">Assessment & Offers</span>
            </a>
            <a class="bg-card-surface hover:bg-surface-container-low border border-outline-variant text-primary p-6 rounded-xl transition-colors flex flex-col items-center justify-center gap-3 text-center group" href="<?= e(url('candidate.onboarding.index')) ?>">
                <span class="material-symbols-outlined text-[48px] text-success group-hover:scale-110 transition-transform">how_to_reg</span>
                <span class="text-xl font-medium">Offers & Onboarding</span>
            </a>
        </div>
    </div>
</div>
